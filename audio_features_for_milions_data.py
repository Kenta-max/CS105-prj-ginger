...
df=pd.read_csv("msongs.csv") #read the ranking.csv
n = len(df.index)

df_gen = pd.DataFrame(columns=['sp_name', 'sp_artist', 'sp_url', 'year', 'popularity','acousticness', 'analysis_url', 'danceability', 'duration_ms', 'energy', 'id', 'instrumentalness',
...
for i in range(n):
    ...
    for track in result["tracks"]["items"]:
        ...
        sp_artist, sp_url, year, popularity, sp_acousticness, 
...
df_gen.to_csv("audio_features_msongs.csv")
